...
<html>
	 ...
	 <body>
		<header class="cabeça" style="background-color:#c0c6d7 !important">
		
			<img src="../ico/logobanner.png" alt="logo do site" /><br><?php $v=random_int(1,3);echo "<span id='prop'>". anuncio("[pp$v]") ."</span>";?>
