...
<html>
	 ...
	 <body>
		<header class="cabeça">
			...
			<img class="ima" src="ico/logocampella.png" alt="logo do site" />
			<nav> 
				<ul>
		...
		<section class="lado">
			<!--lateral esq-->
			<aside>
				<img src="ico/userdefault.png" alt="foto do usuario" />
				<ul id="foto">
			...
			<aside>
				<ul>
					...
					<li><a href="jobs.php">tarefas</a></li>
